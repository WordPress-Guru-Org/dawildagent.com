...
class FrmProStylesController extends FrmStylesController {
	...
	public static function new_style( $return = '' ) {
		...
		self::load_styler( $style ); // As of x.x load_style does not actually use any parameters. This is only passed for legacy versions.
	}
	...
	public static function duplicate( $return = '' ) {
		...
		self::load_styler( $style ); // As of x.x load_style does not actually use any parameters. This is passed for legacy versions.
	}
